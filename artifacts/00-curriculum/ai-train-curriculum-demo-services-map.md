...
| 순서 | 파일 | 핵심 내용 |
|------|------|----------|
| 1 | [Chapter 01: 서비스 처음부터 만들기](../06-demo-services/ai-train-service-chapter-01-getting-started.md) | 메모 서비스 5개 함수(추가·조회·삭제·저장·검색) + 메뉴 루프 |
| - | [기획 워크북](../06-demo-services/ai-train-service-workbook-01-planning.md) | 기능 정의, 구조 설계 워크북 |
...
| 순서 | 파일 | 핵심 내용 |
|------|------|----------|
| 2 | [Chapter 03: 서비스에 테스트 추가하기](../06-demo-services/ai-train-service-chapter-03-testing.md) | assert, unittest, setUp, 테스트 파일 분리 |
| - | [구현 워크북](../06-demo-services/ai-train-service-workbook-02-implementation.md) | 단계별 구현 워크북 |
...
| 순서 | 파일 | 핵심 내용 |
|------|------|----------|
| 3 | [Chapter 02: Lambda에 배포하기](../06-demo-services/ai-train-service-chapter-02-deploy-to-lambda.md) | 터미널 서비스 → Lambda API 변환, URL로 테스트 |
| - | [Lambda 기초 개선판](../06-demo-services/ai-train-service-chapter-02b-lambda-basics-refined.md) | Lambda 핵심 개념 집중 설명 (인지 부하 낮춤) |
...
| 순서 | 파일 | 핵심 내용 |
|------|------|----------|
| 4 | [Chapter 04: GitHub Actions로 자동 배포](../06-demo-services/ai-train-service-chapter-04-github-actions.md) | workflow 파일, GitHub Secrets, push 시 Lambda 자동 배포 |
...
| 파일 | 내용 |
|------|------|
| [진행 체크리스트](../06-demo-services/ai-train-service-checklist-01-progress.md) | 단계별 완료 확인 |
| [구현 순서 노트](../06-demo-services/ai-train-service-note-01-sequence.md) | 기능 구현 순서 참조 |
